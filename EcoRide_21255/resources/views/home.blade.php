            ...
            <div class="card-custom mb-4 text-center">
                ...
                <div class="row mt-5">
                    <div class="col-md-6 mb-3">
                        <div class="card border-success">
                            <div class="card-body">
                                <h2 class="h5 card-title">🚄 Szybka Przejażdżka</h2>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card border-success">
                            <div class="card-body">
                                <h2 class="h5 card-title">♻️ Eco Friendly</h2>
                ...
                <div class="row mt-3">
                    <div class="col-md-6 mb-3">
                        <div class="card border-success">
                            <div class="card-body">
                                <h2 class="h5 card-title">💰 Oszczędne</h2>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card border-success">
                            <div class="card-body">
                                <h2 class="h5 card-title">📱 Łatwe w użyciu</h2>
                ...
                @auth
                    <div class="mt-5">
                        <h2 class="h3 mb-3">Gotów do jazdy?</h2>
                ...
                @else
                    <div class="mt-5">
                        <h2 class="h3 mb-3">Rozpocznij swoją podróż</h2>
